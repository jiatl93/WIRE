...
namespace WireConfigTests
{
    ...
    public static class ConfigFileTestCommon
    {
        ...
        /// <summary>
        ///     The test task item 2 area path
        /// </summary>
        ...
        /// </summary>
        public const string TEST_TASK_ITEM_2_HELP_TEXT =
            "Integer nec imperdiet erat. Nulla egestas dictum elit at ultrices.";
        ...
        private static void SetupVsoConfig(IVSOConfig vsoConfig)
        {
            ...
            var config1 = new TaskItemConfig(
            ...
            var config2 = new TaskItemConfig(
